...
//@description update absensi menjadi true
//@route Put /api/orders/:id/absens
//@access Private/user
const updateOrderAbsen = asyncHandler(async (req, res) => {
    const order = await Order.findById(req.params.id)
...
export {addOrderItems, getOrderById, updateOrderToPaid,getMyOrders, getOrders, updateOrderToDelivered, updateOrderAbsen}
