...
export const ORDER_ABSEN_REQUEST = 'ORDER_ABSEN_REQUEST'
export const ORDER_ABSEN_SUCCESS = 'ORDER_ABSEN_SUCCESS'
export const ORDER_ABSEN_FAIL = 'ORDER_ABSEN_FAIL'
export const ORDER_ABSEN_RESET = 'ORDER_ABSEN_RESET'
